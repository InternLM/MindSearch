...
![Alt Text](/workspaces/MindSearch/assets/1.PNG)
![Alt Text](/workspaces/MindSearch/assets/2.PNG)
## 2 WebPlanner and WebSearcher
MindSearch框架由一个WebPlanner和一组WebSearcher组成。
![Alt Text](/workspaces/MindSearch/assets/3.PNG)
...
![Alt Text](/workspaces/MindSearch/assets/4.PNG)
...
![Alt Text](/workspaces/MindSearch/assets/10.PNG)
#### 1.3 SILICON_API_KEY 获取
https://account.siliconflow.cn/login
https://cloud.siliconflow.cn/account/ak
![Alt Text](/workspaces/MindSearch/assets/11.PNG)
**回到 codespace 中。**
##### 1.3.1 配置环境变量API_KEY
```python
...
![Alt Text](/workspaces/MindSearch/assets/12.PNG)
##### 1.3.2  前端启动
...
```
![Alt Text](/workspaces/MindSearch/assets/13.PNG)
![Alt Text](/workspaces/MindSearch/assets/14.PNG)
...
![Alt Text](/workspaces/MindSearch/assets/15.PNG)
选择公开方便大家可以看到。接下来，我们进入 Settings，配置硅基流动的 api_key。<br>
往下滑，选择 New secrets，name 一栏输入 SILICON_API_KEY，value 一栏输入你的API_KEY的内容。
![Alt Text](/workspaces/MindSearch/assets/16.PNG)
##### 1.4.2 创建一个有写权限的token,点击右上角的头像，点击设置，找到Access Tokens ,新建token。
![Alt Text](/workspaces/MindSearch/assets/17.PNG)
![Alt Text](/workspaces/MindSearch/assets/18.PNG)
##### 1.4.3 新建目录 & 推送代码
...
. 一定不能少
```
![Alt Text](/workspaces/MindSearch/assets/19.PNG)
选择codespaces-blank  看一下仓库里的文件全不全。  （patriotism是我的仓库名）<br>
最终如下：
![Alt Text](/workspaces/MindSearch/assets/20.PNG)
```python
git add .
git commit -m "update"
git push
```
![Alt Text](/workspaces/MindSearch/assets/21.PNG)
#### 1.5 部署gitee.ai
考虑到上传huggingface有一定的困难，部署到国内gitee.ai上，也是一个不错的选择。<br>
 https://ai.gitee.com/  （整体操作和HuggingFace Space类似）
![Alt Text](/workspaces/MindSearch/assets/22.PNG)
##### 1.5.1 进入工作台后，点击应用，新建应用。
![Alt Text](/workspaces/MindSearch/assets/23.PNG)
在输入 应用名称  并选择 许可证 后，其它配置如下所示。
![Alt Text](/workspaces/MindSearch/assets/24.PNG)
同样需要添加app.py入口文件<br>
点击设置，选择功能，新建密钥，键： SILICON_API_KEY，值：硅基流动的 api_key。
![Alt Text](/workspaces/MindSearch/assets/25.PNG)
##### 1.5.2 私人令牌
进入gitee -- 个人设置 -- 私人令牌 。
![Alt Text](/workspaces/MindSearch/assets/26.PNG)
复制令牌<br>
...
git push
```
![Alt Text](/workspaces/MindSearch/assets/27.PNG)
#### 部署到 Modelers
