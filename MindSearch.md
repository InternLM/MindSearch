...
![Alt Text](/MindSearch/assets/1.PNG)
![Alt Text](/MindSearch/assets/2.PNG)
## 2 WebPlanner and WebSearcher
MindSearch框架由一个WebPlanner和一组WebSearcher组成。
![Alt Text](/MindSearch/assets/3.PNG)
...
![Alt Text](/MindSearch/assets/4.PNG)
...
![Alt Text](/MindSearch/assets/10.PNG)
#### 1.3 SILICON_API_KEY 获取
https://account.siliconflow.cn/login
https://cloud.siliconflow.cn/account/ak
![Alt Text](/MindSearch/assets/11.PNG)
**回到 codespace 中。**
##### 1.3.1 配置环境变量API_KEY
```python
...
![Alt Text](/MindSearch/assets/12.PNG)
##### 1.3.2  前端启动
...
```
![Alt Text](/MindSearch/assets/13.PNG)
![Alt Text](/MindSearch/assets/14.PNG)
...
. 一定不能少
```
![Alt Text](/MindSearch/assets/19.PNG)
选择codespaces-blank  看一下仓库里的文件全不全。  （patriotism是我的仓库名）<br>
最终如下：
![Alt Text](/MindSearch/assets/20.PNG)
```python
git add .
git commit -m "update"
git push
```
![Alt Text](/MindSearch/assets/21.PNG)
#### 1.5 部署gitee.ai
考虑到上传huggingface有一定的困难，部署到国内gitee.ai上，也是一个不错的选择。<br>
 https://ai.gitee.com/  （整体操作和HuggingFace Space类似）
![Alt Text](/MindSearch/assets/22.PNG)
##### 1.5.1 进入工作台后，点击应用，新建应用。
![Alt Text](/MindSearch/assets/23.PNG)
在输入 应用名称  并选择 许可证 后，其它配置如下所示。
![Alt Text](/MindSearch/assets/24.PNG)
同样需要添加app.py入口文件<br>
点击设置，选择功能，新建密钥，键： SILICON_API_KEY，值：硅基流动的 api_key。
![Alt Text](/MindSearch/assets/25.PNG)
##### 1.5.2 私人令牌
进入gitee -- 个人设置 -- 私人令牌 。
![Alt Text](/MindSearch/assets/26.PNG)
复制令牌<br>
...
git push
```
![Alt Text](/MindSearch/assets/27.PNG)
#### 部署到 Modelers
