...
MindSearch 是一个开源的 AI 搜索引擎框架，具有与 Perplexity.ai Pro 相同的性能。您可以轻松部署它来构建您自己的搜索引擎，可以使用闭源 LLM（如 GPT、Claude）或开源 LLM。我们的 InternLM2.5 系列模型，例如 [InternLM2.5-20b-chat](https://huggingface.co/internlm/internlm2_5-20b-chat) 和 [InternLM2.5-7b-chat](https://huggingface.co/internlm/internlm2_5-7b-chat)，经过专门优化，能够在 MindSearch 框架中提供卓越的性能。其拥有以下特性：
