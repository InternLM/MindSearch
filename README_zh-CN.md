...
MindSearch 是一个开源的 AI 搜索引擎框架，旨在提供与 Perplexity.ai Pro 相媲美的性能。它支持使用闭源的 LLM 模型（如 GPT、Claude）和开源模型。为了获得最佳效果，我们推荐使用 InternLM2_5 系列的模型，如 [InternLM2_5-20b-chat](https://huggingface.co/internlm/internlm2_5-20b-chat) 和 [InternLM2_5-7b-chat](https://huggingface.co/internlm/internlm2_5-7b-chat)，这些模型经过专门优化，能够在 MindSearch 框架中提供卓越的性能。其拥有以下特性：
